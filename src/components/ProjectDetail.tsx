...
export const ProjectDetail: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0C0C0C] text-[#D7E2EA] flex items-center justify-center font-mono">
  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-[#0C0C0C] text-[#D7E2EA] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-[#D7E2EA]/50 mb-8 max-w-md">
          The project case study you are looking for does not exist or has been moved.
        </p>
        <a 
          href="/#projects" 
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full border-2 border-[#D7E2EA] text-[#D7E2EA] font-semibold uppercase tracking-wider text-sm hover:bg-[#D7E2EA]/10 transition-colors"
        >
  ...
  return (
    <div className="min-h-screen bg-[#0C0C0C] text-[#D7E2EA] py-12 px-4 sm:px-6 md:px-8 lg:px-12 selection:bg-[#BE4C00]/30 selection:text-white">
      <div className="max-w-5xl mx-auto flex flex-col gap-12 md:gap-16 pb-24">
        ...
        >
          <a 
            href="/#projects" 
            className="inline-flex items-center gap-2 text-[#D7E2EA]/60 hover:text-white font-semibold uppercase tracking-wider text-sm transition-colors group"
          >
        ...
        <motion.header 
          ...
          className="relative flex flex-col gap-5 border-b border-[#D7E2EA]/10 pb-8"
        >
          <div className="flex flex-wrap items-center gap-3">
            <span className="bg-[#D7E2EA]/10 text-[#D7E2EA]/90 px-3 py-1 text-[11px] font-mono font-bold uppercase tracking-widest rounded-md">
          ...
          {/* Project Meta Info */}
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 font-medium text-xs sm:text-sm text-[#D7E2EA]/60 mt-2 font-mono">
            {project.tech && (
              <div className="flex items-center gap-1.5">
                <Wrench className="w-4 h-4 text-[#D7E2EA]/40" />
            ...
            {project.teamSize && (
              <>
                ...
                <div className="flex items-center gap-1.5">
                  <Users className="w-4 h-4 text-[#D7E2EA]/40" />
            ...
            {project.duration && (
              <>
                <span className="hidden sm:inline text-[#D7E2EA]/20">|</span>
                <div className="flex items-center gap-1.5">
                  <Calendar className="w-4 h-4 text-[#D7E2EA]/40" />
        ...
        {project.img3 && (
          <motion.div 
            ...
            className="relative w-full aspect-video rounded-[24px] sm:rounded-[36px] overflow-hidden border-2 border-[#D7E2EA]/10 bg-[#0C0C0C] group shadow-[0_30px_60px_rgba(0,0,0,0.8)]"
          >
            <img 
              src={project.img3} 
              alt={project.title} 
            ...
            {project.heroCaption && (
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-4 sm:p-6 md:p-8 flex items-end">
                <p className="text-xs sm:text-sm md:text-base font-medium italic text-[#D7E2EA]/80 font-mono">
                  {project.heroCaption}
                </p>
              </div>
            )}
        ...
        {project.description && (
          <motion.section 
            ...
            className="relative bg-white/[0.02] border border-[#D7E2EA]/5 rounded-[24px] p-6 sm:p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden"
          >
            ...
            <p className="text-base sm:text-lg text-[#D7E2EA]/85 leading-relaxed font-light">
              {project.description}
            </p>
          </motion.section>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {project.problem && (
            <motion.section 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-white/[0.02] border border-[#D7E2EA]/5 hover:border-red-500/20 rounded-[24px] p-6 sm:p-8 shadow-[0_20px_40px_rgba(0,0,0,0.4)] transition-all duration-300 group"
            >
              ...
              <div 
                className="text-sm sm:text-base text-[#D7E2EA]/80 leading-relaxed font-light space-y-4"
          ...
          {project.solution && (
            <motion.section 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-white/[0.02] border border-[#D7E2EA]/5 hover:border-green-500/20 rounded-[24px] p-6 sm:p-8 shadow-[0_20px_40px_rgba(0,0,0,0.4)] transition-all duration-300 group"
            >
              <h2 className="text-lg sm:text-xl font-black uppercase tracking-wide text-white mb-4 flex items-center gap-2">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {project.gallery.map((item, index) => (
                ...
                >
                  <div className="aspect-[4/3] rounded-[18px] sm:rounded-[24px] overflow-hidden border border-[#D7E2EA]/10 bg-white/5 shadow-lg group-hover/gallery:border-[#BE4C00]/30 transition-all duration-300">
                    <img 
                      src={item.url} 
                      alt={item.caption} 
                  ...
                  <p className="text-xs text-[#D7E2EA]/50 font-mono text-center px-2">
                    {item.caption}
                  </p>
                </div>
              ))}
        ...
        {project.results && project.results.length > 0 && (
          <motion.section 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white/[0.02] border border-[#D7E2EA]/5 rounded-[24px] p-6 sm:p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col gap-8 text-center"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 mt-4">
              {project.results.map((r, i) => (
                <div key={i} className="flex flex-col gap-2 items-center">
                  <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full border-2 border-dashed border-[#D7E2EA]/20 flex flex-col items-center justify-center bg-white/[0.03] hover:border-[#BE4C00]/60 hover:bg-[#BE4C00]/5 hover:scale-105 transition-all duration-300 relative shadow-inner">
                  ...
                  <p className="text-xs sm:text-sm font-light text-[#D7E2EA]/60 font-mono">
                    {r.note}
                  </p>
                </div>
              ))}
            ...
            {project.links.map((link, i) => (
              <a 
                ...
                className={`inline-flex items-center gap-2.5 font-bold uppercase tracking-wider text-xs sm:text-sm px-8 py-3.5 border-2 rounded-full transition-all duration-300 hover:-translate-y-0.5 shadow-md ${
                  i === 0 
                    ? 'bg-[#D7E2EA] text-black border-[#D7E2EA] hover:bg-white hover:border-white shadow-[#D7E2EA]/10' 
                    : 'bg-transparent text-[#D7E2EA] border-[#D7E2EA]/20 hover:border-[#D7E2EA] hover:bg-white/5'
                }`}
              >
        ...
        {project.pressLinks && project.pressLinks.length > 0 && (
          <motion.section 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white/[0.02] border border-dashed border-[#D7E2EA]/10 rounded-[24px] p-6 sm:p-8 text-center"
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
              {project.pressLinks.map((p, idx) => (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-[#D7E2EA]/60 hover:text-white transition-colors group font-mono"
                >
                  <ExternalLink className="w-3.5 h-3.5 text-[#BE4C00] group-hover:scale-110 transition-transform" />
                  <span className="border-b border-dashed border-[#D7E2EA]/20 group-hover:border-white">{p.label}</span>
                </a>
              ))}
            </div>
          </motion.section>
        ...
        {nextProject && (
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="border-t border-[#D7E2EA]/10 pt-10"
          >
            <a 
              href={`project.html?id=${nextProject.id}`}
              className="group block bg-white/[0.01] hover:bg-white/[0.03] border border-[#D7E2EA]/5 hover:border-[#BE4C00]/30 rounded-[24px] p-6 sm:p-8 md:p-10 transition-all duration-300 shadow-lg text-center relative overflow-hidden"
            >
              ...
              <span className="text-[#D7E2EA]/40 font-mono text-xs uppercase tracking-widest block mb-1">
                Up Next
              </span>
              ...
              <div className="inline-flex items-center gap-2 mt-4 text-xs font-mono font-bold uppercase tracking-widest text-[#D7E2EA]/40 group-hover:text-white transition-colors">
